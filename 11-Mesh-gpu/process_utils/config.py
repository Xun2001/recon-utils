...
def mesh_config():
    ...
    parser.add_argument('--input_folder',"-i", type=str, default="/home/qinllgroup/hongxiangyu/git_project/livo2-data-utils/10-Mesh-acc/data/tree_01/depth_maps")
    parser.add_argument('--output_folder',"-o", type=str, default="/home/qinllgroup/hongxiangyu/git_project/livo2-data-utils/10-Mesh-acc/data/tree_01/depth_mesh")
